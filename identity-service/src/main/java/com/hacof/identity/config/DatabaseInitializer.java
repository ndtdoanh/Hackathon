...
public class DatabaseInitializer implements CommandLineRunner {
    ...
    private static final Map<String, Set<String>> ROLE_PERMISSIONS = Map.of(
            ...
            "JUDGE",
            Set.of("CREATE_JUDGE_SUBMISSION", "UPDATE_JUDGE_SUBMISSION", "DELETE_JUDGE_SUBMISSION"),
            "MENTOR",
            Set.of(
    ...
    private void createPermissions() {
        List<Permission> permissions = List.of(
                ...
                new Permission(
                        "REVIEW_THREAD_POST_REPORT", "/api/v1/forum-threads/review/{id}", "PUT", "FORUM_THREADS"),
                ...
                new Permission(
                        "DELETE_HACKATHON_RESULT", "/api/v1/hackathons/results/{id}", "DELETE", "HACKATHON_RESULTS"),
                new Permission(
                        "CREATE_BULK_HACKATHON_RESULT",
                        "/api/v1/hackathons/results/bulk-create",
                        "POST",
                        "HACKATHON_RESULTS"),
                new Permission(
                        "UPDATE_BULK_HACKATHON_RESULT",
                        "/api/v1/hackathons/results/bulk-update",
                        "PUT",
                        "HACKATHON_RESULTS"),
                new Permission(
                        "CREATE_INDIVIDUAL_REGISTRATION", "/api/v1/individuals", "POST", "INDIVIDUAL_REGISTRATIONS"),
                new Permission(
                        "UPDATE_INDIVIDUAL_REGISTRATION", "/api/v1/individuals", "PUT", "INDIVIDUAL_REGISTRATIONS"),
                new Permission(
                        "CREATE_BULK_INDIVIDUAL_REGISTRATION",
                        "/api/v1/individuals/bulk",
                        "POST",
                        "INDIVIDUAL_REGISTRATIONS"),
                new Permission(
                        "UPDATE_BULK_INDIVIDUAL_REGISTRATION",
                        "/api/v1/individuals/bulk-update",
                        "PUT",
                        "INDIVIDUAL_REGISTRATIONS"),
                new Permission(
                        "DELETE_INDIVIDUAL_REGISTRATION",
                ...
                new Permission(
                        "APPROVE_MENTORSHIP_REQUEST", "/api/v1/mentorships/approve", "POST", "MENTORSHIP_REQUESTS"),
                new Permission(
                        "REJECT_MENTORSHIP_REQUEST", "/api/v1/mentorships/reject", "POST", "MENTORSHIP_REQUESTS"),
                new Permission("UPDATE_MENTORSHIP_REQUEST", "/api/v1/mentorships", "PUT", "MENTORSHIP_REQUESTS"),
                new Permission(
                        "DELETE_MENTORSHIP_REQUEST", "/api/v1/mentorships/{id}", "DELETE", "MENTORSHIP_REQUESTS"),
                new Permission(
                        "CREATE_MENTORSHIP_SESSION_REQUEST",
                        "/api/v1/mentorships/sessions",
                        "POST",
                ...
                new Permission(
                        "APPROVE_MENTORSHIP_SESSION_REQUEST",
                        "/api/v1/mentorships/sessions/approve",
                        "POST",
                        "MENTORSHIP_SESSION_REQUESTS"),
                new Permission(
                        "REJECT_MENTORSHIP_SESSION_REQUEST",
                        "/api/v1/mentorships/sessions/reject",
                        "POST",
                        "MENTORSHIP_SESSION_REQUESTS"),
                new Permission(
                        "DELETE_MENTORSHIP_SESSION_REQUEST",
                        "/api/v1/mentorships/sessions/{id}",
                        "DELETE",
                        "MENTORSHIP_SESSION_REQUESTS"),
                ...
                new Permission(
                        "CREATE_SPONSORSHIP_HACKATHON",
                        "/api/v1/sponsorships/hackathons",
                        "POST",
                        "SPONSORSHIP_HACKATHONS"),
                new Permission(
                        "UPDATE_SPONSORSHIP_HACKATHON",
                        "/api/v1/sponsorships/hackathons",
                        "PUT",
                ...
                new Permission(
                        "DELETE_SPONSORSHIP_HACKATHON",
                        "/api/v1/sponsorships/hackathons/{id}",
                        "DELETE",
                        "SPONSORSHIP_HACKATHONS"),
                new Permission(
                        "CREATE_SPONSORSHIP_HACKATHON_DETAIL",
                        "/api/v1/sponsorships/details",
                        "POST",
                        "SPONSORSHIP_HACKATHON_DETAILS"),
                new Permission(
                        "UPDATE_SPONSORSHIP_HACKATHON_DETAIL",
                        "/api/v1/sponsorships/details/update-info/{id}",
                        "PUT",
                        "SPONSORSHIP_HACKATHON_DETAILS"),
                new Permission(
                        "UPDATE_SPONSORSHIP_HACKATHON_DETAIL_FILES",
                        "/api/v1/sponsorships/details/update-files/{id}",
                        "PUT",
                        "SPONSORSHIP_HACKATHON_DETAILS"),
                new Permission(
                        "DELETE_SPONSORSHIP_HACKATHON_DETAIL",
                        "/api/v1/sponsorships/details/{id}",
                        "DELETE",
                        "SPONSORSHIP_HACKATHON_DETAILS"),
