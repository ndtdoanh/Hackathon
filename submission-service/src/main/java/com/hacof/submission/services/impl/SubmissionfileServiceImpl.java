...
public class SubmissionfileServiceImpl implements SubmissionfileService {
    ...
    @Override
    public SubmissionfileResponseDTO uploadFile(MultipartFile file, Long submissionId, Long roundId)
            throws IOException {
        ...
        submissionfile.setFileType(
                FileType.valueOf(file.getContentType().split("/")[0])); // Ví dụ: image/jpeg => FileType.IMAGE
