...
public class TeamRoundJudgeMapper {
    ...
    public TeamRoundJudge toEntity(
            TeamRoundJudgeRequestDTO requestDTO,
        ...
        return TeamRoundJudge.builder().teamRound(teamRound).judge(judge).build();
    }
