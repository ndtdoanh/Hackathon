...
public class IdentityController {
    ...
    public ApiResponse<UserResponse> getUserById(@RequestHeader("Authorization") String token, @PathVariable String userId) {
        return identityClientService.getUserById(token, userId);
    }

    @GetMapping("/users/username/{username}")
    public ApiResponse<UserResponse> getUserByUsername(@RequestHeader("Authorization") String token, @PathVariable String username) {
    ...
    public ApiResponse<List<UserResponse>> getUsersByCreatedByUserName(@RequestHeader("Authorization") String token, @PathVariable String createdByUserName) {
