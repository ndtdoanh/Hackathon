...
public interface IdentityClientService {
    ...
    ApiResponse<UserResponse> getUserByUsername(@RequestHeader("Authorization") String token, @PathVariable String username);
    ...
    ApiResponse<List<UserResponse>> getUsersByCreatedByUserName(@RequestHeader("Authorization") String token, @PathVariable String createdByUserName);
}
