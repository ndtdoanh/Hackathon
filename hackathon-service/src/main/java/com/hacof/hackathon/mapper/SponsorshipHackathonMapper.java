...
//            target = "hackathonId",
//            expression =
//                    "java(sponsorshipHackathon.getHackathon() != null ?
// String.valueOf(sponsorshipHackathon.getHackathon().getId()) : null)")
//    @Mapping(
//            target = "sponsorshipId",
//            expression =
//                    "java(sponsorshipHackathon.getSponsorship() != null ?
// String.valueOf(sponsorshipHackathon.getSponsorship().getId()) : null)")
//    @Mapping(
//            target = "createdByUserName",
//            expression =
//                    "java(sponsorshipHackathon.getCreatedBy() != null ?
// sponsorshipHackathon.getCreatedBy().getUsername() : null)")
//    @Mapping(
//            target = "lastModifiedByUserName",
//            expression =
//                    "java(sponsorshipHackathon.getLastModifiedBy() != null ?
// sponsorshipHackathon.getLastModifiedBy().getUsername() : null)")
