...
public interface SponsorshipHackathonDetailMapper {
    ...
    @Mapping(
            ...
            expression =
                    "java(sponsorshipHackathonDetail.getSponsorshipHackathon() != null ? String.valueOf(sponsorshipHackathonDetail.getSponsorshipHackathon().getId()) : null)")
    @Mapping(
            target = "createdByUserName",
            expression =
                    "java(sponsorshipHackathonDetail.getCreatedBy() != null ? sponsorshipHackathonDetail.getCreatedBy().getUsername() : null)")
    @Mapping(
            target = "lastModifiedByUserName",
            expression =
                    "java(sponsorshipHackathonDetail.getLastModifiedBy() != null ? sponsorshipHackathonDetail.getLastModifiedBy().getUsername() : null)")
