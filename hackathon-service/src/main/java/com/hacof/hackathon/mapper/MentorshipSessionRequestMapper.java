...
//            expression =
//                    "java(mentorshipSessionRequest.getEvaluatedBy() != null ?
// String.valueOf(mentorshipSessionRequest.getEvaluatedBy().getId()) : null)")
//    @Mapping(
//            target = "createdByUserName",
//            expression =
//                    "java(mentorshipSessionRequest.getCreatedBy() != null ?
// mentorshipSessionRequest.getCreatedBy().getUsername() : null)")
//    @Mapping(
//            target = "lastModifiedByUserName",
//            expression =
//                    "java(mentorshipSessionRequest.getLastModifiedBy() != null ?
// mentorshipSessionRequest.getLastModifiedBy().getUsername() : null)")
